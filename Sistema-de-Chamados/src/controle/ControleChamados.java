...
public class ControleChamados {
    ...
    public String retornaDetalhesChamado(Chamado c) {
        ...
        String detalhes = "\n" + "--------" + "\n" + "Data de abertura do chamado: "
                ...
                + "Titulo do chamado: " + c.getTitulo() + "\n" + "Descriaao do chamado: " + c.getDescricao() + "\n"
